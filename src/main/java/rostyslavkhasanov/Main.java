...
import static rostyslavkhasanov.constants.Constants.INTEGER_INPUT;
import static rostyslavkhasanov.constants.Constants.MENU;
import static rostyslavkhasanov.constants.Constants.MENU_NUMBER_RANGE;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        context.scan("rostyslavkhasanov");
        context.refresh();
